...
<tr>
<td class="hr">&nbsp;</td>
<td class="hr"><?php echo "Id grada" ?></td>
...
?>
<tr>
<td class="<?php echo $style ?>"><a href="grad.php?a=view&recid=<?php echo $i ?>">Uredi/Izbrisi</a></td>
...
<tr>
<td class="hr"><?php echo htmlspecialchars("grad")."&nbsp;" ?></td>
<td class="dr"><input type="text" name="grad" maxlength="30" value="<?php echo str_replace('"', '&quot;', trim($row["grad"])) ?>"></td>
</tr>
</table>
<?php } ?>
...
<tr>
<td class="addbtn"><a href="grad.php?a=add">Dodaj</a></td>
<?php if ($page > 1) { ?>
<td><a href="grad.php?page=<?php echo $page - 1 ?>">&lt;&lt;&nbsp;Prethodna</a>&nbsp;</td>
<?php } ?>
<?php
  global $pagerange;
...
<?php } else { ?>
<td><a href="grad.php?page=<?php echo $j ?>"><?php echo $j ?></a></td>
<?php } } } else { ?>
<td><a href="grad.php?page=<?php echo $startpage ?>"><?php echo $startpage ."..." .$count ?></a></td>
<?php } } } ?>
<?php if ($page < $pagecount) { ?>
<td>&nbsp;<a href="grad.php?page=<?php echo $page + 1 ?>">Sledeca&nbsp;&gt;&gt;</a>&nbsp;</td>
<?php } ?>
</tr>
</table>
<?php } ?>
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td><a href="grad.php">Pocetna stranica</a></td>
<?php if ($recid > 0) { ?>
<td><a href="grad.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>">Prethodna stranica</a></td>
<?php } if ($recid < $count - 1) { ?>
<td><a href="grad.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Sledeca stranica</a></td>
<?php } ?>
</tr>
</table>
<hr size="1" noshade>
...
<hr size="1" noshade>
<form enctype="multipart/form-data" action="grad.php" method="post">
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td class="addbtn"><a href="grad.php?a=edit&recid=<?php echo $recid ?>">Uredi</a></td>
<td class="addbtn"><a href="grad.php?a=del&recid=<?php echo $recid ?>">Izbrisi</a></td>
</tr>
</table>
<?php
  mysqli_free_result($res);
...
function sql_insert()
{
  ...
  $sql = "insert into `grad` (`id`, `grad`) values (" .sqlvalue(@$_POST["id"], false).", " .sqlvalue(@$_POST["grad"], true).")";
...
function sql_update()
{
  ...
  $sql = "update `grad` set `id`=" .sqlvalue(@$_POST["id"], false).", `grad`=" .sqlvalue(@$_POST["grad"], true) ." where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
...
function sql_delete()
{
  ...
  $sql = "delete from `grad` where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
