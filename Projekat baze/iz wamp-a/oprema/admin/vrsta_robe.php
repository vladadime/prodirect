...
?>
<tr>
<td class="<?php echo $style ?>"><a href="vrsta_robe.php?a=view&recid=<?php echo $i ?>">Uredi/Izbrisi</a></td>
...
<tr>
<td class="addbtn"><a href="vrsta_robe.php?a=add">Dodaj</a>&nbsp;</td>
<?php if ($page > 1) { ?>
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td class="addbtn"><a href="vrsta_robe.php?a=edit&recid=<?php echo $recid ?>">Uredi</a></td>
<td class="addbtn"><a href="vrsta_robe.php?a=del&recid=<?php echo $recid ?>">Izbrisi</a></td>
</tr>
</table>
<?php
  mysqli_free_result($res);
...
?>
<br>
<form action="vrsta_robe.php" method="post">
...
function sql_update()
{
  ...
  $sql = "update `vrsta_robe` set `id`=" .sqlvalue(@$_POST["id"], false).", `vrsta_robe`=" .sqlvalue(@$_POST["vrsta_robe"], true) ." where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
...
function sql_delete()
{
  ...
  $sql = "delete from `vrsta_robe` where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
