...
?>
<br>
<form action="kupci.php" method="post">
...
function sql_update()
{
  ...
  $sql = "update `kupci` set `id`=" .sqlvalue(@$_POST["id"], false).", `ime`=" .sqlvalue(@$_POST["ime"], true).", `prezime`=" .sqlvalue(@$_POST["prezime"], true).", `adresa`=" .sqlvalue(@$_POST["adresa"], true).", `telefon`=" .sqlvalue(@$_POST["telefon"], true).", `id_grad`=" .sqlvalue(@$_POST["id_grad"], false).", `email`=" .sqlvalue(@$_POST["email"], true) ." where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
...
function sql_delete()
{
  ...
  $sql = "delete from `kupci` where " .primarykeycondition();
  mysqli_query($conn, $sql) or die(mysqli_error());
}
